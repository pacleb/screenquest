...
- `.github/workflows/backend-ci.yml` — lint, type-check, unit tests, integration tests (with PostgreSQL + Redis services), build, coverage upload
- `.github/workflows/mobile-ci.yml` — lint, type-check, EAS build (preview profile)
- `.github/workflows/cms-ci.yml` — lint, type-check, build
