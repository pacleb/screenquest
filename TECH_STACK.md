...
| CI/CD | GitLab CI | 3 stages: test → build → deploy |
| CI Docker | Docker-in-Docker (DinD) 27 | Image pushed to GitLab Container Registry |
...
| Source Control | GitLab | gitlab.com/pacleb/screenquest |
...
| GitLab | https://gitlab.com/pacleb/screenquest |
