...
public class AppDelegate: ExpoAppDelegate {
  ...
  public override func application(
    ...
    // Initialize Firebase BEFORE anything else so APNs ↔ FCM token mapping works
  ...
  // GULAppDelegateSwizzler can fail with Swift / ExpoAppDelegate inheritance,
  // so we do the forwarding ourselves to guarantee the APNs↔FCM mapping.
  public override func application(
    _ application: UIApplication,
