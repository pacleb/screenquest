...
const questLibraryData = [
  ...
  { name: 'No screen time for 1 hour', description: 'Spend a full hour doing activities that don't involve screens', icon: '📵', category: 'mindfulness', suggestedRewardSeconds: 1800, suggestedStackingType: 'non_stackable', ageRange: 'all', sortOrder: 4 },
  ...
  { name: 'Clean the pet area', description: 'Clean your pet's cage, bed, litter box, or tank', icon: '🐾', category: 'pet_care', suggestedRewardSeconds: 1200, suggestedStackingType: 'non_stackable', ageRange: 'ages_8_12', sortOrder: 3 },
